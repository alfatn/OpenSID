		...
		<td align='right'></td>
			...
			<?php foreach ($l['sub_pendapatan'] as $s): ?>
				<tr class='bold'>
					...
					<td align='right'><?= number_format($s['realisasi'][0]['realisasi']+$s['realisasi_bunga'][0]['realisasi'])?></td>
					<td align='right'><?= number_format($s['anggaran'][0]['pagu']-($s['realisasi'][0]['realisasi']+$s['realisasi_bunga'][0]['realisasi'])) ?></td>
					...
					<?php foreach ($s['sub_pendapatan2'] as $q): ?>
						<tr>
							...
							<td align='right'><?= number_format($q['realisasi'][0]['realisasi']+$q['realisasi_bunga'][0]['realisasi']) ?></td>
			...
			<td align='right'><?= number_format($l['realisasi'][0]['realisasi']+$l['realisasi_bunga'][0]['realisasi'])?></td>
			<td align='right'><?= number_format(($l['anggaran'][0]['pagu']) - ($l['realisasi'][0]['realisasi']+$l['realisasi_bunga'][0]['realisasi']))?></td>
			<td align='right'><?= number_format(($l['realisasi'][0]['realisasi']+$l['realisasi_bunga'][0]['realisasi'])/($l['anggaran'][0]['pagu'])*100, 2)?> </td>
			</tr>
		<?php endforeach ?>
	...
	<?php foreach ($belanja as $b): ?>
		...
		<?php foreach ($b['sub_belanja'] as $b1): ?>
			...
			<tr class='bold'>
				...
				<td align='right'><?= number_format($b1['realisasi'][0]['realisasi']+$b1['realisasi_spj'][0]['realisasi']+$b1['realisasi_bunga'][0]['realisasi'])?></td>
				<td align='right'><?= number_format(($b1['anggaran'][0]['pagu'])-($b1['realisasi'][0]['realisasi']+$b1['realisasi_spj'][0]['realisasi']+$b1['realisasi_bunga'][0]['realisasi'])) ?></td>
				...
				<?php foreach ($b1['sub_belanja2'] as $b2): ?>
					<tr>
						...
						<td align='right'><?= number_format($b2['realisasi'][0]['realisasi']+$b2['realisasi_spj'][0]['realisasi']+$b2['realisasi_bunga'][0]['realisasi']) ?></td>
		...
		<tr class='bold highlighted'>
			...
			<td align='right'><?= number_format($b['realisasi'][0]['realisasi']+$b['realisasi_spj'][0]['realisasi']+$b['realisasi_bunga'][0]['realisasi'])?></td>
			<td align='right'><?= number_format(($b['anggaran'][0]['pagu']) - ($b['realisasi'][0]['realisasi']+$b['realisasi_spj'][0]['realisasi']+$b['realisasi_bunga'][0]['realisasi']))?></td>
			<td align='right'><?= number_format(($b['realisasi'][0]['realisasi']+$b['realisasi_spj'][0]['realisasi']+$b['realisasi_bunga'][0]['realisasi'])/($b['anggaran'][0]['pagu'])*100, 2)?> </td>
		</tr>
	<?php endforeach ?>
	</tr>
	...
	<?php foreach ($pembiayaan as $p): ?>
	  <tr class='bold'>
		...
		<tr class='bold highlighted'>
			...
			<td align='right'><?= number_format((($l['realisasi'][0]['realisasi']+$l['realisasi_bunga'][0]['realisasi'])-($b['realisasi'][0]['realisasi']+$b['realisasi_spj'][0]['realisasi']+$b['realisasi_bunga'][0]['realisasi']))+(($p1['realisasi'][0]['realisasi'])-($pk1['realisasi'][0]['realisasi']))) ?></td>
			<td align='right'><?= number_format(((($l['anggaran'][0]['pagu'])-($b['anggaran'][0]['pagu']))-(($l['realisasi'][0]['realisasi']+$l['realisasi_bunga'][0]['realisasi'])-($b['realisasi'][0]['realisasi']+$b['realisasi_spj'][0]['realisasi']+$b['realisasi_bunga'][0]['realisasi'])))+(($p1['anggaran'][0]['pagu'])-($pk1['anggaran'][0]['pagu'])-(($p1['realisasi'][0]['realisasi'])-($pk1['realisasi'][0]['realisasi']))))?></td>
			<td align='right'></td>
		</tr>
		</tr>
